 ...
 */
final class Version20240201144724 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8933C4328805AB2F ON favoris (annonce_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8933C4328805AB2F ON favoris');
    }
}
