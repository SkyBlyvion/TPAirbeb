 ...
 */
final class Version20240123085951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE annonce_id type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE annonce CHANGE type_id annonce_id INT DEFAULT NULL');
